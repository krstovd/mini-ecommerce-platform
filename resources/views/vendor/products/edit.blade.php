<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('vendor.products.update', $product) }}" class="bg-white shadow rounded p-6 space-y-4">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="url" name="image_url" class="w-full border rounded px-3 py-2" value="{{ old('image_url', $product->image_url) }}">
                </div>
